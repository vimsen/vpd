$(document).ready(function() {
    ...
    function createVGWDiv(vgwname, drUrl, macaddress, ipaddress, group, applianceObject, objAttributes, city) {
        ...
        ali.innerHTML = '<div class="row"><div class="col-md-12 col-sm-6 m-b-5 m-t-5">' +
            ...
            '</div></div>' +
            '<div class="row">' +
            '<div class="col-md-3 col-sm-6 m-b-5 m-t-5"><font color="white">Passive local controllers</font></div>' +
            '<div class="col-md-9 col-sm-6">' +
        ...
        var optionsDashboard = {
            ...
            onSuccess: function() {
                ...
                for (var i = 0; i < macAddressesPendingData.length; i++) {
                    client.subscribe("telint/" + macAddressesPendingData[i] + "/sla_type/", {
                        qos: 0
                    });
                    client.subscribe("telint/" + macAddressesPendingData[i] + "/duration_start/", {
                        qos: 0
                    });
                    client.subscribe("telint/" + macAddressesPendingData[i] + "/duration_stop/", {
                        qos: 0
                    });
                    client.subscribe("telint/" + macAddressesPendingData[i] + "/max_reduction/", {
                        qos: 0
                    });
                    client.subscribe("telint/" + macAddressesPendingData[i] + "/min_reliability/", {
                        qos: 0
                    });
                    client.subscribe("telint/" + macAddressesPendingData[i] + "/penalty/", {
                        qos: 0
                    });
                    client.subscribe("telint/" + macAddressesPendingData[i] + "/min_price/", {
                        qos: 0
                    });
                    client.subscribe("telint/" + macAddressesPendingData[i] + "/plugs/", {
                        qos: 0
                    });
                }
                macAddressesPendingData = [];
                clientTriedConnection = false;
            },
        ...
        if (!clientConnected && !clientTriedConnection) {
            ...
            client.subscribe("telint/" + macaddress + "/sla_type/", {
                qos: 0
            });
            client.subscribe("telint/" + macaddress + "/duration_start/", {
                qos: 0
            });
            client.subscribe("telint/" + macaddress + "/duration_stop/", {
                qos: 0
            });
            client.subscribe("telint/" + macaddress + "/max_reduction/", {
                qos: 0
            });
            client.subscribe("telint/" + macaddress + "/min_reliability/", {
                qos: 0
            });
            client.subscribe("telint/" + macaddress + "/penalty/", {
                qos: 0
            });
            client.subscribe("telint/" + macaddress + "/min_price/", {
                qos: 0
            });
            client.subscribe("telint/" + macaddress + "/plugs/", {
                qos: 0
            });
        }
    }
